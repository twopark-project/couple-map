...
class _MapDetailScreenState extends State<MapDetailScreen> {
  ...
  // 추억 작성 모달
  Future<void> _showCreateMemoryModal(Place place) async {
  ...
  Future<void> _loadMemories() async {
    ...
    try {
      ...
      final memories = await _apiService.getMemoryList(accessToken, widget.mapInfo.mapId);
